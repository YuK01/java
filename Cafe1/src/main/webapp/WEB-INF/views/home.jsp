	...
	<tr>
		<td style="border:1px solid black;">
			<table>
				...
				<tr>
					<td>
						메뉴명&nbsp;
						<input type=text id=menuname name=menuname size=10 readonly>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						금액&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=number id=price name=price style="width:100px" readonly>
					</td>
				</tr>
				<tr>
					<td align=right>
		...
		<td style="border:1px solid black;">			
			<table>
				...
				<tr>
					<td>
						<select id=selOrder style='width:200px' size=10></select>
					</td>
				</tr>
				<tr>
					<td>
						총액&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=number id=total name=total style="width:100px">
					</td>
				</tr>
				<tr>
					<td>
						모바일&nbsp;
						<input type=text id=mobile name=mobile size=12>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td align=right>
						...
						<button id=btnCancle>주문취소</button>
					</td>
				</tr>
			</table>
		</td>
		<td style="border:1px solid black;" valign=top>
			<table>
				...
				<tr>
					<td>
						<select id=selSales style='width:200px' size=17></select>
					</td>
				</tr>
			</table>
		</td>
			...
			<td>
				<table>
					<tr>
						<td>
							code&nbsp;&nbsp;
							<input type=text id=d_code name=d_code size=3>
						</td>
					</tr>
					<tr>						
						<td>
							name&nbsp;&nbsp;
							<input type=text id=d_name name=d_name size=10>
						</td>
					</tr>
					<tr>
						<td>
							price&nbsp;
							<input type=number id=d_price name=d_price style="width:100px">
						</td>
					</tr>
					<tr>
						<td align=right>
